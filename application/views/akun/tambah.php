				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('akun/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode_akun"><strong>Kode Akun</strong></label>
											<!-- value="<?= mt_rand(10000000, 99999999) ?>" -->
											<input type="text" name="kode_akun" placeholder="Masukkan Kode akun" autocomplete="off"  value="AKUN-<?= mt_rand(1000000, 9999999) ?>" class="form-control" required  maxlength="15" readonly>
										</div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="no_akun" placeholder="Masukkan Nama akun" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<hr>
