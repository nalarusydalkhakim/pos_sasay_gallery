				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('pengeluaran/bayar_hutang/' . $pengeluaran->kode_pengeluaran) ?>" id="form-tambah" method="POST">
									<div class="form-row">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="jumlah_show" class="form-control"  value="Rp. <?= number_format($pengeluaran->jumlah, 0, ',', '.')?>" readonly>
											<input type="hidden" name="jumlah" class="form-control"  value="<?= $pengeluaran->jumlah ?>" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="kepada"><strong>Kepada</strong></label>
											<input type="text" name="kepada"  class="form-control" value="<?= $pengeluaran->kepada?>" readonly>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode_akun"><strong>Nama Akun</strong></label>
											<input type="text" name="kode_akun" class="form-control"  value="<?= $pengeluaran->nama_akun?>" readonly>
										</div>
									</div>
									<div class="form-row">
