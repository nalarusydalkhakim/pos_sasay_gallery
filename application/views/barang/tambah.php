...
<body id="page-top">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('barang/proses_tambah') ?>" id="form-tambah"  name="form-tambah"method="POST" onsubmit="return validateForm()">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode_barang"><strong>Kode Barang</strong></label>
											<!-- value="<?= mt_rand(10000000, 99999999) ?>" -->
											<input type="text" name="kode_barang" placeholder="Masukkan Kode Barang" autocomplete="off"  value="B-<?= mt_rand(10000000, 99999999) ?>" class="form-control" required  maxlength="15" readonly>
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="kode_brand"><strong>Brand</strong></label>
											<select name="kode_brand" id="kode_brand" class="form-control" required>
	...
	<script>
		function validateForm() {
			var harga_beli = document.forms["form-tambah"]["harga_beli"].value;
			var harga_jual = document.forms["form-tambah"]["harga_jual"].value;
