								...
								<form action="<?= base_url('kategori/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode_kategori" placeholder="Masukkan Kode kategori" autocomplete="off"  value="K-<?= mt_rand(1000000, 9999999) ?>" class="form-control" required  maxlength="15" readonly>
										</div>
										<div class="form-group col-md-6">
